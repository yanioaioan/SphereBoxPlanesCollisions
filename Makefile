...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -o Makefile SphereBoxPlanesCollisions.pro
#############################################################################
...
DISTDIR = /home/yioannidis/QtStuff/Projects/SphereBoxPlanesCollisions/obj/SphereBoxPlanesCollisions1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/home/yioannidis/NGL/lib -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
...
DIST          = /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		SphereBoxPlanesCollisions.pro include/NGLScene.h src/NGLScene.cpp \
		src/main.cpp
...
Makefile: SphereBoxPlanesCollisions.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/qt/5.5/gcc_64/mkspecs/common/unix.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/linux.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile SphereBoxPlanesCollisions.pro
...
moc/moc_NGLScene.cpp: ../../../NGL/include/ngl/Camera.h \
		...
		include/NGLScene.h
	/opt/qt/5.5/gcc_64/bin/moc $(DEFINES) -I/opt/qt/5.5/gcc_64/mkspecs/linux-g++ -I/home/yioannidis/QtStuff/Projects/SphereBoxPlanesCollisions -I/home/yioannidis/QtStuff/Projects/SphereBoxPlanesCollisions/include -I/home/yioannidis/NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtOpenGL -I/opt/qt/5.5/gcc_64/include/QtWidgets -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore include/NGLScene.h -o moc/moc_NGLScene.cpp
